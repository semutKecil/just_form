    ...
    return JustField<T>(
      ...
      builder: (context, state) {
        return DropdownButton<T>(
          ...
          icon: state.getAttribute("icon") ?? icon,
          iconDisabledColor:
              state.getAttribute("iconDisabledColor") ?? iconDisabledColor,
          iconEnabledColor:
              state.getAttribute("iconEnabledColor") ?? iconEnabledColor,
          iconSize: state.getAttribute("iconSize") ?? iconSize,
          elevation: state.getAttribute("elevation") ?? elevation,
          style: state.getAttribute("style") ?? style,
          underline: state.getAttribute("underline") ?? underline,
          isDense: state.getAttribute("isDense") ?? isDense,
          isExpanded: state.getAttribute("isExpanded") ?? isExpanded,
          itemHeight: state.getAttribute("itemHeight") ?? itemHeight,
          menuMaxHeight: state.getAttribute("menuMaxHeight") ?? menuMaxHeight,
          enableFeedback:
              state.getAttribute("enableFeedback") ?? enableFeedback,
          alignment: state.getAttribute("alignment") ?? alignment,
          borderRadius: state.getAttribute("borderRadius") ?? borderRadius,
          padding: state.getAttribute("padding") ?? padding,
          barrierDismissible:
              state.getAttribute("barrierDismissible") ?? barrierDismissible,
          ...
          dropdownColor: state.getAttribute("dropdownColor") ?? dropdownColor,
          menuWidth: state.getAttribute("menuWidth") ?? menuWidth,
          onTap: onTap,
        );
      },
    );
